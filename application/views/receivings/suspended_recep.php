<?php
$attach_receives = $_SESSION['attach_receives'] ?? array();
?>
...
<div class="md-modal-header" style="padding: 0.4em 0.8em;">
    <div class="md-modal-header-left">
        ...
        <div class="md-modal-header-info">
            ...
            <span class="md-modal-ref"><?php echo count($attach_receives); ?> commande<?php echo count($attach_receives) > 1 ? 's' : ''; ?> &agrave; rattacher</span>
        </div>
    </div>
...
<div class="md-card" style="padding: 0.4em 0.6em;">
    <table class="rsp-table">
        ...
        <tbody>
            <?php foreach ($attach_receives as $row) {
                $supplier_name = '';
            ...
            ?>
            <tr>
                <td class="rsp-id">CMDE-<?php echo $row['receiving_id']; ?></td>
                ...
                <td>
                    <div class="rsp-actions">
                        <a href="<?php echo site_url($_SESSION['controller_name'].'/attach_reception/'.$row['receiving_id']); ?>" class="rsp-action-btn" title="<?php echo $this->lang->line('receivings_select') ?: 'S&eacute;lectionner'; ?>">
...
<?php } else { ?>
<div class="rsp-empty">Aucune commande disponible pour rattachement.</div>
<?php } ?>
...
<div class="md-modal-footer" style="padding: 0.35em 0.8em;">
    <div class="md-modal-footer-left">
        <span style="font-size: 0.75em; color: var(--text-secondary, #94a3b8);">
            <?php echo count($attach_receives); ?> commande<?php echo count($attach_receives) > 1 ? 's' : ''; ?>
        </span>
    </div>
