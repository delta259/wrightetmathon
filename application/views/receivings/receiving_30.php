...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;flex-wrap:wrap;">
	...
	<div class="search-input-wrapper" style="position:relative;">
		...
		<input id="item" name="item" type="text" class="md-form-input" placeholder="Recherche article..." style="max-width:300px;padding:8px 12px 8px 34px;" tabindex="5">
	</div>
	</form>
	<?php if (empty($cart)): ?>
	...
	<?php
		...
		else
		{
			...
			// making up the kit and thier price
				...
				<td><a href="<?php echo site_url("receivings/inventory/$cur_item_info->item_id");?>"> <?php echo round($cur_item_info->quantity,0); ?></a></td>
				...
				?>
					...
					<?php echo form_input(array(
						            'type' => 'number',
												'name'					=>	'quantity',
												'value'					=>	round(number_format($item['quantity'], 2),0),
...
<?php
	...
	switch ($_SESSION['show_dialog'])
	{
		...
		case	6:
				...
				include('../wrightetmathon/application/views/receivings/inventory_low_by_date.php');
		break;
	}
?>
