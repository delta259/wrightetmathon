...
<div class="page-header">
    <h1 class="page-title">
        ...
        <?php echo $this->lang->line('modules_customer_profiles'); ?>
    </h1>
    <div class="page-actions">
        <a href="<?php echo site_url('customer_profiles/view/-1'); ?>" class="btn-action btn-primary">
            ...
            <?php echo $this->lang->line('customer_profiles_new'); ?>
        </a>
    </div>
</div>
...
<div class="table-container">
    <div class="table-wrapper">
        ...
        <table class="tablesorter" id="sortable_table">
            <thead>
                <tr>
                    <th><?php echo $this->lang->line('customer_profiles_profile_name'); ?></th>
                    <th><?php echo $this->lang->line('customer_profiles_profile_description'); ?></th>
                    <th><?php echo $this->lang->line('customer_profiles_profile_discount'); ?></th>
                    <th><?php echo $this->lang->line('customer_profiles_profile_fidelity'); ?></th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($data_var->result() as $p): ?>
                <tr class="profile-row" data-href="<?php echo site_url('customer_profiles/view/' . $p->profile_id); ?>" style="cursor:pointer;">
                    <td><?php echo anchor('customer_profiles/view/' . $p->profile_id, htmlspecialchars($p->profile_name)); ?></td>
                    <td><?php echo htmlspecialchars($p->profile_description); ?></td>
                    <td style="text-align:right;"><?php echo htmlspecialchars($p->profile_discount); ?>%</td>
                    <td style="text-align:center;">
                        <?php if ($p->profile_fidelity === 'Y'): ?>
                    ...
                    <td style="text-align:center;white-space:nowrap;">
                        <a href="#" onclick="if(confirm('Supprimer ce profil client ?')){window.location='<?php echo site_url('customer_profiles/delete/' . $p->profile_id); ?>';} return false;" title="Supprimer" style="text-decoration:none;">
...
$(document).ready(function() {
    ...
    $('#sortable_table').on('click', 'tr.profile-row td:not(:last-child)', function() {
...
{
    include('../wrightetmathon/application/views/customer_profiles/form.php');
