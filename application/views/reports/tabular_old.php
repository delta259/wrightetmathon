			...
			<tbody>
				...
				if($_SESSION['oeil_desactivation']=='1')
				{
					if($request_for_quantity['quantity']<=0)
					{
					    ...
					    {
			            ?>	
                           <td style="text-align:center;"><a href="<?php echo site_url("receivings/desactive/$tout"); ?>"><img src="<?php echo base_url().$_SESSION['url_image'].'/reactive.png';?>" width="30px" height="15px" alt="reactive" title='reactive'></a></td>
				        <?php
			            }
			            else
			            {
			            ?>
				           <td style="text-align:center;"><a href="<?php echo site_url("receivings/desactive/$tout"); ?>"><img src="<?php echo base_url().$_SESSION['url_image'].'/desactive.png';?>" width="25px" height="25px" alt="Desactive" title='désactive'></a></td>		
                        <?php
                        }		
                    } 
	                else
				...
				{
					//echo "<td></td>"; //Rien ne doisetre affiché
				}
	?>
