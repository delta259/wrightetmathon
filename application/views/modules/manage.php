...
<div class="page-header">
    <h1 class="page-title">
        ...
        <?php echo $this->lang->line('modules_modules'); ?>
    </h1>
    <div class="page-actions">
        <a href="<?php echo site_url('modules/view/-1'); ?>" class="btn-action btn-primary">
            ...
            <?php echo $this->lang->line('modules_new'); ?>
        </a>
    </div>
</div>
...
<div style="margin-bottom:16px;">
    ...
    <input id="search" name="search" type="text" placeholder="Nom du module..." tabindex="5"
...
<div class="table-container">
    <div class="table-wrapper">
        ...
        <table class="tablesorter" id="sortable_table">
            <thead>
                <tr>
                    <th><?php echo $this->lang->line('modules_module_name'); ?></th>
                    <th><?php echo $this->lang->line('modules_module_name_lang_key'); ?></th>
                    <th><?php echo $this->lang->line('modules_module_sort'); ?></th>
                    <th><?php echo $this->lang->line('modules_module_user_menu'); ?></th>
                    <th><?php echo $this->lang->line('modules_module_admin_menu'); ?></th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($data_var->result() as $m): ?>
                <tr class="module-row" data-href="<?php echo site_url('modules/view/' . $m->module_id); ?>" style="cursor:pointer;">
                    <td><?php echo anchor('modules/view/' . $m->module_id, htmlspecialchars($m->module_name)); ?></td>
                    <td><?php echo htmlspecialchars($m->name_lang_key); ?></td>
                    <td style="text-align:center;"><?php echo htmlspecialchars($m->sort); ?></td>
                    <td style="text-align:center;">
                        <?php if ($m->user_menu === 'Y'): ?>
                    ...
                    <td style="text-align:center;white-space:nowrap;">
                        <a href="#" onclick="if(confirm('Supprimer ce module ?')){window.location='<?php echo site_url('modules/delete/' . $m->module_id); ?>';} return false;" title="Supprimer" style="text-decoration:none;">
...
$(document).ready(function() {
    ...
    $('#sortable_table').on('click', 'tr.module-row td:not(:last-child)', function() {
