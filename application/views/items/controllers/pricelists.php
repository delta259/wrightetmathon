...
class Pricelists extends CI_Controller
{
	...
	*/
	...
	function verify()
	{
		...
		if ($_SESSION['new'] == 1 OR $_SESSION['transaction_info']->pricelist_name != $_SESSION['original_pricelist_name'])
		{
		...
		{
			if ($_SESSION['new'] == 1 OR $_SESSION['transaction_info']->pricelist_default != $_SESSION['original_pricelist_default'])
			{
