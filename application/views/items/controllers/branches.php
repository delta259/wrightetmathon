...
class Branches extends CI_Controller
{
	...
	*/
	...
	function verify()
	{
		...
		if ($_SESSION['new'] == 1 OR $_SESSION['transaction_info']->branch_code != $_SESSION['original_branch_code'])
		{
		...
		if ($_SESSION['transaction_info']->branch_allows_check == 'Y')
		{
			...
			if ($_SESSION['new'] == 1 OR $_SESSION['transaction_info']->branch_ip != $_SESSION['transaction_info_original']->branch_ip)
			{
