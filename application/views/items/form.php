        ...
        <div>
            ...
            <div class="md-card">
                ...
                <div class="md-toggle-group">
                    ...
                    <label class="md-toggle">
                        ...
                        <span class="md-toggle-value"><?php echo $_SESSION['selected_dluo_indicator']; ?></span>
                    </label>
                    <?php echo form_dropdown(
                        'dluo_indicator',
                ...
                <div class="md-toggle-group">
                    ...
                    <label class="md-toggle">
                        ...
                        <span class="md-toggle-slider"></span>
                        <span class="md-toggle-value"><?php echo $_SESSION['selected_giftcard_indicator']; ?></span>
                    </label>
                    <?php echo form_dropdown(
                        'giftcard_indicator',
                        $_SESSION['G']->YorN_pick_list,
                ...
                <div class="md-toggle-group">
                    ...
                    <label class="md-toggle">
                        ...
                        <span class="md-toggle-slider"></span>
                        <span class="md-toggle-value"><?php echo $_SESSION['selected_offer_indicator']; ?></span>
                    </label>
                    <?php echo form_dropdown(
                        'offer_indicator',
                        $_SESSION['G']->YorN_pick_list,
            ...
            <div class="md-card">
                ...
                <div style="display:flex; gap:24px; flex-wrap:wrap; margin-bottom:14px;">
                    <!-- Export Franchise -->
                    <div class="md-toggle-group" style="margin-bottom:0;">
                        <span class="md-toggle-label" style="min-width:auto;"><?php echo $this->lang->line('items_export_to_franchise'); ?></span>
                        <label class="md-toggle">
                            <input type="checkbox" class="md-toggle-input" data-target="export_to_franchise"
                                <?php echo ($_SESSION['selected_export_to_franchise'] == 'Y') ? 'checked' : ''; ?>>
                            <span class="md-toggle-slider"></span>
                        </label>
                        <?php echo form_dropdown(
                            'export_to_franchise',
                            ...
                            'class="md-toggle-select" id="export_f" style="display:none;"'
                        ); ?>
                    </div>

                    <!-- Export Integree -->
                    <div class="md-toggle-group" style="margin-bottom:0;">
                        <span class="md-toggle-label" style="min-width:auto;"><?php echo $this->lang->line('items_export_to_integrated'); ?></span>
                        <label class="md-toggle">
                            <input type="checkbox" class="md-toggle-input" data-target="export_to_integrated"
                                <?php echo ($_SESSION['selected_export_to_integrated'] == 'Y') ? 'checked' : ''; ?>>
                            <span class="md-toggle-slider"></span>
                        </label>
                        <?php echo form_dropdown(
                            ...
                            'class="md-toggle-select" id="export_i" style="display:none;"'
                        ); ?>
                    </div>

                    <!-- Export Autre -->
                    <div class="md-toggle-group" style="margin-bottom:0;">
                        <span class="md-toggle-label" style="min-width:auto;"><?php echo $this->lang->line('items_export_to_other'); ?></span>
                        <label class="md-toggle">
                            <input type="checkbox" class="md-toggle-input" data-target="export_to_other"
                                <?php echo ($_SESSION['selected_export_to_other'] == 'Y') ? 'checked' : ''; ?>>
                            <span class="md-toggle-slider"></span>
                        </label>
                        <?php echo form_dropdown(
                            'export_to_other',
                            ...
                            'class="md-toggle-select" id="export_o" style="display:none;"'
                        ); ?>
                    </div>
                </div>
                ...
                if ($_SESSION['show_image'] != 'N' && isset($_SESSION['transaction_info']->item_id)) {
                    ...
                    if (!empty($img_data->image_file_name)) {
                        ...
                        if (preg_match('/^[a-zA-Z0-9][-a-zA-Z0-9]*\.[a-zA-Z]/', $img_data->image_file_name)) {
                            ...
                            // Ce n'est pas une URL valide, utiliser l'image par défaut
                            $product_image_url = base_url() . 'SLIDES_VENTES/cadre.png';
                        }
                    }
                }
...
<!-- Image URL Edit Script -->
<script type="text/javascript">
// Fonction globale pour éditer l'image (compatible AJAX loading)
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                // Vérifier si c'est une URL valide (contient un domaine avec un point)
